...
object decode_table extends consts{
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    AUIPC  -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(U_TYPE),   BitPat(SRC_IMM),    BitPat(SRC_PC),   BitPat(ALU_ADD),     BitPat(BR_N),             BitPat(MEM_N)), //?)??
    ADDI   -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(I_TYPE),   BitPat(SRC_RS),     BitPat(SRC_IMM),  BitPat(ALU_ADD),     BitPat(BR_N),             BitPat(MEM_N)), 
//  EBREAK, -> List(Y,   BitPat(FU_MEM),       Y,        BitPat(N_TYPE),   BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
    ...
    SLTI   -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(I_TYPE),   BitPat(SRC_RS),     BitPat(SRC_IMM),  BitPat(ALU_SLT),     BitPat(BR_N),             BitPat(MEM_N)), 
    SLTIU  -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(I_TYPE),   BitPat(SRC_RS),     BitPat(SRC_IMM),  BitPat(ALU_SLTU),    BitPat(BR_N),             BitPat(MEM_N)), 
    XORI   -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(I_TYPE),   BitPat(SRC_RS),     BitPat(SRC_IMM),  BitPat(ALU_XOR),     BitPat(BR_N),             BitPat(MEM_N)), 
    ORI    -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(I_TYPE),   BitPat(SRC_RS),     BitPat(SRC_IMM),  BitPat(ALU_OR),      BitPat(BR_N),             BitPat(MEM_N)), 
    ANDI   -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(I_TYPE),   BitPat(SRC_RS),     BitPat(SRC_IMM),  BitPat(ALU_AND),     BitPat(BR_N),             BitPat(MEM_N)), 
    ADDIW  -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(I_TYPE),   BitPat(SRC_RS),     BitPat(SRC_IMM),  BitPat(ALU_ADD),     BitPat(BR_N),             BitPat(MEM_N)), 
    ...
    SLLI   -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(I_TYPE),   BitPat(SRC_RS),     BitPat(SRC_IMM),  BitPat(ALU_SL),      BitPat(BR_N),             BitPat(MEM_N)), 
    SRLI   -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(I_TYPE),   BitPat(SRC_RS),     BitPat(SRC_IMM),  BitPat(ALU_SRL),     BitPat(BR_N),             BitPat(MEM_N)), 
    SRAI   -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(I_TYPE),   BitPat(SRC_RS),     BitPat(SRC_IMM),  BitPat(ALU_SRA),     BitPat(BR_N),             BitPat(MEM_N)), 
    SLLIW  -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(I_TYPE),   BitPat(SRC_RS),     BitPat(SRC_IMM),  BitPat(ALU_SL),      BitPat(BR_N),             BitPat(MEM_N)), 
    SRLIW  -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(I_TYPE),   BitPat(SRC_RS),     BitPat(SRC_IMM),  BitPat(ALU_SRL),     BitPat(BR_N),             BitPat(MEM_N)), 
    SRAIW  -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(I_TYPE),   BitPat(SRC_RS),     BitPat(SRC_IMM),  BitPat(ALU_SRA),     BitPat(BR_N),             BitPat(MEM_N)), 
    ...
    SLL    -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(R_TYPE),   BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_SL),      BitPat(BR_N),             BitPat(MEM_N)), 
    SLT    -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(R_TYPE),   BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_SL),      BitPat(BR_N),             BitPat(MEM_N)), 
    SLTU   -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(R_TYPE),   BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_SL),      BitPat(BR_N),             BitPat(MEM_N)), 
...
//  MUL    -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  MULH   -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  MULHSU -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  MULHU  -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  DIV    -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  DIVU   -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  REM    -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  REMU   -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  MULW   -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  DIVW   -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  DIVUW  -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  REMW   -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  REMUW  -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
    ADDW   -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(R_TYPE),   BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_ADD),     BitPat(BR_N),             BitPat(MEM_N)), 
    SUBW   -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(R_TYPE),   BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_SUB),     BitPat(BR_N),             BitPat(MEM_N)), 
    SLLW   -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(R_TYPE),   BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_SL),      BitPat(BR_N),             BitPat(MEM_N)), 
    SRLW   -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(R_TYPE),   BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_SRL),     BitPat(BR_N),             BitPat(MEM_N)), 
    SRAW   -> List(Y,    BitPat(FU_ALU),       Y,        BitPat(R_TYPE),   BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_SRA),     BitPat(BR_N),             BitPat(MEM_N)), 
//  MULW.Q -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  DIVW.Q -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  DIVUW.Q-> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  REMW.Q -> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
//  REMUW.Q-> List(Y,    BitPat(FU_MEM),       Y,        BitPat(R,    )    BitPat(SRC_RS),     BitPat(SRC_RS),   BitPat(ALU_NONE),    BitPat(BR_N),             BitPat(MEM_N)), 
  //J      -> List(Y,    BitPat(FU_BRU),       N,        BitPat(J_TYPE),   BitPat(SRC_IMM),    BitPat(SRC_N),    BitPat(ALU_NONE),    BitPat(BR_J),             BitPat(MEM_N)), 
    JAL    -> List(Y,    BitPat(FU_BRU),       Y,        BitPat(J_TYPE),   BitPat(SRC_IMM),    BitPat(SRC_N),    BitPat(ALU_NONE),    BitPat(BR_J),             BitPat(MEM_N)), 
